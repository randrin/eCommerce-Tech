                      ...
                      {confirmation ? (
                        <>
                          <div className="store-reset-confirmation text-center mb-3">
                            <h4 className="mb-3">
                              Nous vous avons envoyé un e-mail pour la
                              réinitialisation de votre mot de passe
                            </h4>
                            <p className="mb-2">
                              Si vous ne recevez pas cette e-mail, nous vous
                              invitions de vérifier dans la section SPAM de
                        ...
                        <>
                          <div className="text-center mb-3">
                            ...
                            <p>
                              Saisissez l'adresse mail que vous nous avez
                              indiquée lors de votre inscription, afin de
                              recevoir un lien de réinitialisation de votre mot
                              de passe.{" "}
                            </p>
                          </div>
