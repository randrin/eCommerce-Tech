...
export default class PolitiquesConfidentialite extends Component {
  render() {
    return (
      <>
        <Navbar />
        <main className="main">
          <Translation>
            {(t) => (
              <>
                <HeroBanner title={t("PRIVACY_POLICY.HEROBANNER_TITLE")} />
                <Breadcrumb
                  title={<span>{t("PRIVACY_POLICY.BREADCRUMB")}</span>}
                />
                  ...
                  <div className="row">
                    <div className="col my-5">
                      <p className="text-justify">
                        ...
                        dapibus eu, fermentum et, dapibus sed, urna. Morbi purus
                        ...
                        eu, fermentum et, dapibus sed, urna. Morbi purus libero,
                        ...
                        et, dapibus sed, urna. Morbi purus libero, faucibus
                        ...
                        dapibus sed, urna. Morbi purus libero, faucibus
                        adipiscing, commodo quis, gravida id, est. Sed lectus.
                        Praesent elementum hendrerit tortor. Sed semper lorem at
                        felis. Vestibulum volutpat, lacus a ultrices sagittis,
                        mi neque euismod dui, eu pulvinar nunc sapien ornare
